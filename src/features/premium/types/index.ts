...
export const PREMIUM_THEMES: PremiumTheme[] = [
  { id: 'system', name: 'System', icon: '🖥️', colors: { primary: '#3B82F6', secondary: '#8B5CF6', background: '#FFFFFF', surface: '#F3F4F6', text: { primary: '#111827', secondary: '#4B5563', tertiary: '#9CA3AF' }, border: '#E5E7EB', status: { success: '#10B981', warning: '#F59E0B', error: '#EF4444', info: '#3B82F6' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: false },
  { id: 'dark', name: 'Dark', icon: '🌙', colors: { primary: '#60A5FA', secondary: '#A78BFA', background: '#111827', surface: '#1F2937', text: { primary: '#F9FAFB', secondary: '#D1D5DB', tertiary: '#6B7280' }, border: '#374151', status: { success: '#34D399', warning: '#FBBF24', error: '#F87171', info: '#60A5FA' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: false },
  { id: 'midnight', name: 'Midnight', icon: '🌌', colors: { primary: '#818CF8', secondary: '#C084FC', background: '#0F0F23', surface: '#1A1A2E', text: { primary: '#F8F8FF', secondary: '#B8B8D1', tertiary: '#6B6B8D' }, border: '#2D2D4A', status: { success: '#4ADE80', warning: '#FBBF24', error: '#F87171', info: '#818CF8' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
  { id: 'ocean', name: 'Ocean', icon: '🌊', colors: { primary: '#06B6D4', secondary: '#0EA5E9', background: '#F0F9FF', surface: '#E0F2FE', text: { primary: '#0C4A6E', secondary: '#0369A1', tertiary: '#7DD3FC' }, border: '#BAE6FD', status: { success: '#10B981', warning: '#F59E0B', error: '#EF4444', info: '#0EA5E9' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
  { id: 'forest', name: 'Forest', icon: '🌲', colors: { primary: '#22C55E', secondary: '#16A34A', background: '#F0FDF4', surface: '#DCFCE7', text: { primary: '#14532D', secondary: '#166534', tertiary: '#86EFAC' }, border: '#BBF7D0', status: { success: '#22C55E', warning: '#F59E0B', error: '#EF4444', info: '#22C55E' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
  { id: 'sunrise', name: 'Sunrise', icon: '🌅', colors: { primary: '#F97316', secondary: '#FB923C', background: '#FFFBEB', surface: '#FEF3C7', text: { primary: '#78350F', secondary: '#92400E', tertiary: '#FDBA74' }, border: '#FDE68A', status: { success: '#22C55E', warning: '#F59E0B', error: '#EF4444', info: '#F97316' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
  { id: 'graphite', name: 'Graphite', icon: '⬛', colors: { primary: '#6366F1', secondary: '#4F46E5', background: '#18181B', surface: '#27272A', text: { primary: '#FAFAFA', secondary: '#A1A1AA', tertiary: '#71717A' }, border: '#3F3F46', status: { success: '#22C55E', warning: '#F59E0B', error: '#EF4444', info: '#6366F1' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
  { id: 'copper', name: 'Copper', icon: '🟤', colors: { primary: '#D97706', secondary: '#B45309', background: '#FFFBEB', surface: '#FEF3C7', text: { primary: '#78350F', secondary: '#92400E', tertiary: '#FCD34D' }, border: '#FDE68A', status: { success: '#22C55E', warning: '#F59E0B', error: '#EF4444', info: '#D97706' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
  { id: 'aurora', name: 'Aurora', icon: '✨', colors: { primary: '#EC4899', secondary: '#D946EF', background: '#FDF2F8', surface: '#FCE7F3', text: { primary: '#831843', secondary: '#9D174D', tertiary: '#F9A8D4' }, border: '#FBCFE8', status: { success: '#22C55E', warning: '#F59E0B', error: '#EF4444', info: '#EC4899' }, premium: { gold: '#FFD700', silver: '#C0C0C0', bronze: '#CD7F32' } }, isPremiumRequired: true },
];
